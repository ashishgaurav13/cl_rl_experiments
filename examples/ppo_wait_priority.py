...
parser.add_argument("-file", default = "models/wait_priority.pt",
    help = "(default file is models/wait_priority.pt)")
...
if args.train:
    ...
    eval_env = craft.WaitPriorityEnv()
    evaluate(agent, args.file, render = args.render)